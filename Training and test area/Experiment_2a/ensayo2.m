...
for alpha = alphas
    ...
    intex =double_factorial(2*alpha)*exp(z)*pi*besseli(alpha+1/2,z)*z^(-1/2-alpha);

    t = linspace(0,pi,n+1);  t =1+ cos(t);
    y = g(t);
    [intN, ErrEst]= CleCurExpRule(y.',z,'endpoint',2);
