...
%
% returns res a matrix with
%
% * first row: alpha, z, exact value
% * next rows: n, approximated integral, error, abs(error)
%
% alpha can be a vector. In this case, res is a cell with 
% res{j} the results corresponding to alpha(j)
%
