...
%  Different calling modes + comparison with exact integral
%  Fejer rule is also tested
% --------------------------------------------------------------
%
% November 2025
%
...
%% --------------------------------------------------------------
% Method 5: Fejér rule (experimental). No error estimate available either
% ---------------------------------------------------------------
[ints(5), errs(5)] = CleCurExpRule(f, z, ...
    'NumberOfNodes', nNodes, ...
    'EndPoint', b, ...
    'FejerRule', true);
